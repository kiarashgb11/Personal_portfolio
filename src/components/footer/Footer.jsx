...
const Footer = () => (
  <footer className="footer">
    <div className="container footer__inner">
      ...
      <div className="footer__nav"><span>Connect</span><a href="https://github.com/kiarashgb11" target="_blank" rel="noreferrer">GitHub <FiGithub /></a><a href="https://www.linkedin.com/in/kiarashalirezaei/" target="_blank" rel="noreferrer">LinkedIn <FiLinkedin /></a><a href={CV} download>Résumé</a></div>
